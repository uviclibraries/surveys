---
layout: default
title: 4 - Advanced Questions Type
nav_order: 4
...
8. To turn this into a weighted question select **use Weights**<br>
...
## Single Row Rating
1. Follow the same steps of a matrix question; but then you do not need to add rows, as there will only be the main question and a rating scale. To do this, select **"Make this a single-row rating scale (remove row choices)."**. (see screenshot below)<br>
