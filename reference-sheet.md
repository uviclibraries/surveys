...
SurveyMonkey has great resources on how to develop and design surveys. Beyond the tips we summarize below, we recommend reading this 10-15-minute-long [article on survey best practices](https://www.surveymonkey.com/mp/survey-guidelines/).
...
-	Avoid [leading and loaded questions](https://www.surveymonkey.com/curiosity/how-to-avoid-asking-leading-and-loaded-questions/) (e.g., “Do you agree that…). These questions might bias the respondents to answer in a certain way, and hence will not provide you with the results you want. 
-	Avoid using indefinite qualifiers (e.g., only, just, merely, many, few, or seldom).
-	This [short guide ](https://prod.smassets.net/assets/content/sm/5-survey-writing-mistakes-eguide.pdf) has some good examples on how to rephrase questions to avoid key mistakes in survey design.
